    ...
    <body>
        ...
        <form action="{{route('guardar')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="app" value="{{old('app')}}" placeholder="González">
                <div class="form-text">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="apm" value="{{old('apm')}}" placeholder="García">
                <div class="form-text">
